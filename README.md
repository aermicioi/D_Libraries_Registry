...
| [turtle](https://github.com/sociomantic-tsunami/turtle)               | BSL                  | Yes |2017-11-03|Black box application testing library/framework
...
| [eventcore](https://github.com/vibe-d/eventcore)                      | MIT                  | No  |2017-10-31|High performance proactor event loop abstraction library
...
| [cryption](https://github.com/shove70/cryption)                       | Apache 2             | Yes |2017-10-25|A D Library of encryption, decryption, encode, hash, and message digital signatures.
...
| [dhtnode](https://github.com/sociomantic-tsunami/dhtnode)             | MIT                  | No  |2017-11-02|Distributed hash-table node
...
| library                                                               | license              | GC  |last update| description
|---------------------------------------------------------------------- |:--------------------:|:---:|:---------:| -----------
| [io](https://github.com/MartinNowak/io) 							    | BSL 1                | No  |2017-11-01|Core I/O functionality
...
| library                                                               | license              | GC |last update| description
|---------------------------------------------------------------------- |:--------------------:|:---:|:---------:| -----------
| [dlang-requests](https://github.com/ikod/dlang-requests)              | BSL 1                | Yes |2017-11-03|dlang http client library inspired by python-requests
| [libhttp2](https://github.com/etcimon/libhttp2)                       | MIT                  | Yes |2017-10-18|HTTP/2 library in D, translated from nghttp2
| [nanomsg-wrapper](https://github.com/kaleidicassociates/nanomsg-wrapper)               | Boost                | No |2017-08-17|d-lang bindings for nanomsg
...
| library                                                               | license              | GC |last update| description
|---------------------------------------------------------------------- |:--------------------:|:---:|:---------:| -----------
| [asdf](https://github.com/tamediadigital/asdf)                        | BSL 1               | Yes |2017-10-09|fast and simple JSON for Dlang 
...
| [jwtd](https://github.com/olehlong/jwtd)                              | MIT                  | Yes |2017-06-26|D implementation of JSON Web Token.
...
| [dpeq](https://github.com/Boris-Barboris/dpeq)                        | MIT                  | Yes |2017-10-25|PSQL extended query TCP client for D
